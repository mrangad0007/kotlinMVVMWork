...
import com.cdinv.kotlinmvvmretrofitwork.MainActivity
import com.cdinv.kotlinmvvmretrofitwork.R
import com.cdinv.kotlinmvvmretrofitwork.api.RetrofitInstance
import com.cdinv.kotlinmvvmretrofitwork.databinding.ActivityEditBinding
import com.cdinv.kotlinmvvmretrofitwork.detail.EXTRA_POST
...
class EditActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.post.observe(this, Observer { updatePost ->
            if (updatePost == null) {
                binding.clPostResult.visibility = View.GONE
                return@Observer
            }
            binding.tvUpdatedTitle.text = updatePost.title
            binding.tvUpdatedContent.text = updatePost.body
